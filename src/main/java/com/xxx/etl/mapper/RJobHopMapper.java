...
/**
 * @ClassName 类名 : RJobHopMapper
 * @Description 作用 : TODO(这里用一句话描述这个类的作用)
 * @Author 作者 : Lilg
 * @Date 创建时间 : 2017年5月5日 上午11:49:49
 * @Version 版本 : V1.0
 */

public interface RJobHopMapper extends SysMapper<RJobHop> {
	 ...
	 * @Version: V1.0
	 */
	List<RJobHop> getMiddleNode(@Param("idJob") Integer idJob, @Param("idJobentryCopyFrom") Integer idJobentryCopyFrom);
